...
public class CorrecaoERecuperacaoDoFosforo {
    ...
    double calculoDaQuantidadeDaFonteAplicar(double teorDeFosforoAtingir, double quantFosforoNoSolo,
            double eficienciaDoFosforo, TiposDeFontesDeFosforo fonteDeFosforoUtilizar) {
    ...
    double[] calculaValoresDosNutrientesAdicionais(TiposDeFontesDeFosforo fonteDeFosforoUtilizar,
    ...
    double calculoDoCustoDaFonteUtilizarPorHectare(String fonteDeFosforoUtilizar,
            double calculoDaQuantidadeDaFonteAplicar, double valorPorTonelada) {
